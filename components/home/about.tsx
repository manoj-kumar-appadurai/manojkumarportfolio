...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        I am a UI/UX Designer and Front-End Developer with 3+ years of experience creating responsive, user-friendly web and mobile interfaces.{" "}
      </span>
      <span
      ...
      >
        I design and build clean, accessible experiences using Figma, HTML, CSS, JavaScript, and React.js.
      </span>
    </h1>
  );
